...
export interface ChatRequest {
  ...
  chatType?: 'poiche' | 'salon_de_the' | 'miroir_free' | 'miroir_paid';
  sessionId?: string;
}
...
class ChatService {
  ...
  async createSession(chatType: 'poiche' | 'salon_de_the' | 'miroir_free' | 'miroir_paid', title?: string): Promise<ChatSessionSummary> {
  ...
  async sendMessage(
    messages: Message[],
  chatType: 'poiche' | 'salon_de_the' | 'miroir_free' | 'miroir_paid' = 'poiche',
    sessionId?: string
